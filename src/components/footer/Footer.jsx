...
import logofooter from '../../assets/images/logo/logo-dark.svg'
const Footer = () => {
    ...
    const socialList = [
     
        {
         ...
         {
          icon: "fab fa-youtube",
         link: "https://www.youtube.com/channel/UCkYuexnezaWYFufYWOl9JsA"
       },
        {
            icon: "icon-fl-tik-tok-2",
             link: "https://www.tiktok.com/@whycapetown?lang=en"
         },
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-12 col-12">
                            <div className="widget widget-logo">
                                ...
                                <p className="sub-widget-logo">We accept US Dollars, GBP and Euros! </p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-7 col-12">
                            <div className="widget widget-subcribe">
                                <h5 className="title-widget">Follow us on:</h5>
