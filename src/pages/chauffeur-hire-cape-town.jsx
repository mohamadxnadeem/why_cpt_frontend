            ...
            <div className="inner-content">
              ...
              <div className="inner-post mg-t-40">
                <p className="mg-bt-24">
                  We specialize in premium chauffeured drives bespoke to your
                  requirements with professional drivers in top-of-the-line
                  vehicles for sophisticated professionals and international
                  millionaires. Book your chauffeured drivers or self-drive
                  option with us for a 5-star experience. Guaranteed.
                </p>
              </div>
              <Cars4Hire />
            </div>
                                  ...
                                  <>
                                    ...
                                    <div className="col-md-12">
                                      <textarea
                                        ...
                                        placeholder="Please let us know which vehcile you want and the dates you need it for"
                                        onChange={handleChange}
                                      ></textarea>
                                    </div>
                                    <div className="col-md-12">
